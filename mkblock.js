    ...
    // Нет ошибки, поехали!
      ...
      extensions.forEach((extention) => {
        ...
        // Если это HTML
          ...
          fileContent = `<!--DEV\n\nДля использования этого файла как шаблона:\n\n@ @include('blocks/${blockName}/${blockName}.html', {"class": ""})\n@ @include('../${blockName}/${blockName}.html', {"class": ""})\n@ @loop("blocks/${blockName}/${blockName}.html", "json/data.json")\n@ @loop("../${blockName}/${blockName}.html", "json/data.json")\n\n(Нужно убрать пробел между символами @)\nПодробнее: https://www.npmjs.com/package/gulp-file-include\n\n<div class="${blockName}  @@class">content</div>\n-->\n`;
          // fileCreateMsg = '';
        }
